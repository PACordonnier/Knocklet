...
* CONSTANTES
*---------------------------------------------------------------------------*/
#define BIX_ADR1_CORP 0x12									// Addresse corporate(1 byte de l'adresse du device BLE)
#define BIX_ADR2_CORP 0x34									// Addresse corporate(2 byte de l'adresse du device BLE)
#define BIX_ADR3_CORP 0x08									// Addresse corporate(3 byte de l'adresse du device BLE)
